  ...
  const navSections = [
    {
      ...
      items: [
        ...
        { id: 'analytics', label: 'Analytics', icon: TrendingUp, color: 'text-green-600' },
      ]
    },
    {
      title: 'Patient Care',
      items: [
        ...
        { id: 'consultations', label: 'Consultations', icon: Stethoscope, color: 'text-teal-600' },
        { id: 'prescriptions', label: 'Prescriptions', icon: Pill, color: 'text-pink-600' },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 'diagnoses', label: 'Diagnoses', icon: ClipboardList, color: 'text-red-600' },
        { id: 'lab-results', label: 'Lab Results', icon: Activity, color: 'text-cyan-600' },
        { id: 'medical-history', label: 'Medical History', icon: FileSearch, color: 'text-amber-600' },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 'staff', label: 'Staff', icon: UserPlus, color: 'text-violet-600' },
      ]
    },
    {
      title: 'System',
      items: [
        { id: 'reports', label: 'Reports', icon: FileText, color: 'text-slate-600' },
        { id: 'audit', label: 'Audit Trail', icon: Shield, color: 'text-rose-600' },
